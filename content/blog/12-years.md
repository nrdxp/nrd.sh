...
description = "Why I Left Social Media Over a Decade Ago"
date = 2024-10-11
tags = ["philosophy"]
+++
...
> **Update, 2026:** This post announced my experimental return to social media. That experiment is over. I closed my X account, and honestly, the experience only reinforced everything I wrote below. These platforms remain myopic, coherence-draining profit machines that are a net negative to society. The "connection and reach" they promise is real for a select few willing to sell enough of themselves to satisfy the algorithm, but that doesn't excuse the dystopian scaffolding required to deliver it. Something better can exist without all that. Stay tuned.
...
Still, I couldn't resist tinkering, breaking, modding, or hacking anything within reach during whatever free time I had. Android ROM hacks, torrented music libraries, hosting random stuff - you name it.
...
This passion is even expressed through my handle, nrdxp. I think there were a lot of kids like me in the 90s, but I don't think all of them made it this far. Growing up poor and starting a career late with 3 kids will do that. I'm not some oracle from on high, and I still have my own struggles. But what else is there? Complain? Gross...

## Not an Innovation; a Virus

As fascinated as I am with technology, social media is just boring to me. But it's worse than that. I had some hope it could help usher in a new era of connectedness (naive, I know), and I tried to push for it.
...
Read a history book. Just pick one. All this nonsense has happened before, many times. I am one man, living my one life, and I refuse to be told by a brainless mob how to think. I'll take responsibility for my own mistakes, take credit for my own wins. Where's the inclusivity for folks like me?
...
This segment could go on, but the header says it all. Identity isn't a feeling; it's defined by your character. How you look will do little to affect it, and obsessing over appearances will likely degrade what actually matters.
